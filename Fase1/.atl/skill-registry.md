...
- C:\Users\alvar\Desktop\CCVII\Proyecto\CC7-Proyecto-2026\Fase1 (project root: no project-level skills, no AGENTS.md/CLAUDE.md/.cursorrules)
...
- Note: Not applicable to this C/ASM project — included for registry completeness.
- Rules:
...
### SDD skills (sdd-explore, sdd-propose, sdd-spec, sdd-design, sdd-tasks, sdd-apply, sdd-verify, sdd-archive)
- Path: C:\Users\alvar\.config\opencode\skills\sdd-*/SKILL.md
- Trigger: Orchestrator-launched only. Not user-invokable.
- Rules: Each follows the SDD phase contract defined in shared conventions.

## Project Convention Files

No project-level convention files detected (no AGENTS.md, CLAUDE.md, .cursorrules, GEMINI.md, or copilot-instructions.md).

The agent's global `AGENTS.md` at `C:\Users\alvar\.config\opencode\AGENTS.md` provides the authoritative persona and behavior contract.

## SDD Persistence

- **Mode**: `engram` (default — Engram is available, no openspec requested)
- **Initialization saved to**: `sdd-init/CC7-Proyecto-2026` (topic_key, Engram ID: 19)
- **Testing capabilities**: `sdd/CC7-Proyecto-2026/testing-capabilities` (Engram ID: 20)
- **Registry**: `skill-registry` (Engram ID: 21)
