...
for OBJ in "${!OS_TO_LINK[@]}"; do
    ...
    arm-none-eabi-gcc -nostdlib -nostartfiles -T "${OS_TO_LINK[$OBJ]}" \
        -o "${OBJ%.o}.elf" \
        bin/root.o bin/os_io.o bin/io_common.o bin/time.o bin/uart.o bin/pcb.o bin/scheduler.o bin/timer.o bin/svc.o bin/watchdog.o bin/interrupts.o bin/fault.o $OBJ \
        -lgcc
done
